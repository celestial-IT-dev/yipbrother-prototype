...
export const ROLE_VISIBLE_STATUSES: Record<Role, OrderStatus[]> = {
  [ROLES.SALES]: [
    // Sales can only see cancelled orders on the dashboard
    STATUSES.CANCELLED,
  ],
  [ROLES.ADMIN]: [
  ...
  [ROLES.DESIGNER]: [
    // Designer sees orders from DESIGN_IN_PROGRESS stage onwards
    STATUSES.DESIGN_IN_PROGRESS,
    STATUSES.PENDING_DESIGN_APPROVAL,
    STATUSES.MATERIAL_PLANNING,
    STATUSES.WAITING_FOR_MATERIALS,
  ...
  [ROLES.PRODUCTION_ENGINEER]: [
    // Production engineer sees orders from production stage onwards
    STATUSES.PRODUCTION_STARTED,
    STATUSES.FABRICATION_IN_PROGRESS,
    STATUSES.ASSEMBLY_IN_PROGRESS,
    STATUSES.PAINTING_IN_PROGRESS,
